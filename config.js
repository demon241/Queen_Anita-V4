...
global.owner = process.env.OWNER_NUMBER.split('241062407867'); 
global.anitav4 = process.env.BOT_NAME || "𝐐𝐔𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀-𝐕𝟒";
global.ownername = process.env.OWNER_NAME || "𝑫𝒂𝒘𝒔𝒐𝒏 ";
global.packname = process.env.PACK_NAME || "𝑫𝒂𝒘𝒔𝒐𝒏 𝒕𝒆 𝒇𝒖𝒄𝒌";
